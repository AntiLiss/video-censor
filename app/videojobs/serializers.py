...
#     input_video = attrs.get('input_video')
#     print(input_video.temporary_file_path())
#     if not has_audio(input_video):
#         raise ValidationError(
#             "Your video must have an audio to apply audio censorship!"
#         )
# #     return attrs
...
#     print(validated_data.get("input_video").temporary_file_path())
